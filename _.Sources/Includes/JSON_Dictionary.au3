...
;~ 			$s_JSON_String &= StringRegExpReplace(StringFormat("%g", $o_Object), '(-?(?>0|[1-9]\d*)(?>\.\d+)?)(?:([eE][-+]?)0*(\d+))?', "$1$2$3", 1)
		...
		Case "Binary"
			$s_JSON_String &= '"' & _jsnd_Base64Encode($o_Object) & '"'
		Case "Array"
...
; Syntax ........: _jsnd_Base64Encode(Const ByRef $s_Input, [Const $b_base64url = False])
...
; Author ........: AspirinJunkie
; Example .......: Yes
;                  $s_Base64String = _jsnd_Base64Encode("This is my test")
; =================================================================================================
Func _jsnd_Base64Encode(Const ByRef $s_Input, Const $b_base64url = False)
	...
	Return $s_Output
EndFunc   ;==>_jsnd_Base64Encode


; #FUNCTION# ======================================================================================
; Name ..........: _jsnd_Base64Decode
...
; Syntax ........: _jsnd_Base64Decode(Const ByRef $s_Input, [Const $b_base64url = False])
...
; Author ........: AspirinJunkie
; Example .......: Yes
;                  MsgBox(0, '', BinaryToString(_jsnd_Base64Decode("VGVzdA")))
; =================================================================================================
Func _jsnd_Base64Decode(Const ByRef $s_Input, Const $b_base64url = False)
	Local $h_DLL_Crypt32 = DllOpen("Crypt32.dll")
